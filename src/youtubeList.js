...
import { Accordion, Text,View, Container, List, ListItem,  Header, Content, Card, CardItem, Icon,Left, Body, Right,NativeBaseProvider} from "native-base";
...
class YouTubeList extends React.Component {
    constructor(props) {
    super(props);
    console.log("YouTubeList:",props.tubelist);
    //setting default state
    //setting default state
    this.state = { dataArray: props.tubelist ||this.props.location.state.record.payload.items, text: '',name:'test0'||this.props.location.state.record.title, baseURL:'test1url1'||this.props.location.state.record.url};
